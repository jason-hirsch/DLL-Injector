/****************************************************************************
** Meta object code from reading C++ file 'processwindow.hpp'
**
...
#include "../../JigglyInjector/processwindow.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'processwindow.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 40, 23), // "on_selectButton_clicked"
QT_MOC_LITERAL(4, 64, 23), // "on_cancelButton_clicked"
QT_MOC_LITERAL(5, 88, 24), // "on_searchBar_textChanged"
QT_MOC_LITERAL(6, 113, 4) // "arg1"

    },
    "ProcessWindow\0on_refreshButton_clicked\0"
...
void ProcessWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProcessWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_refreshButton_clicked(); break;
        case 1: _t->on_selectButton_clicked(); break;
        case 2: _t->on_cancelButton_clicked(); break;
        case 3: _t->on_searchBar_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject ProcessWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_ProcessWindow.data,
    qt_meta_data_ProcessWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
